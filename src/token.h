...
typedef enum {
    ...
    TOKEN_COMPTIME,         /* comptime (compile-time field iteration: comptime for/if) */
    ...
    TOKEN_TYPE_F32,         /* f32 */
    TOKEN_TYPE_F64,         /* f64 */
    TOKEN_TYPE_F16,         /* f16 (half) */
    TOKEN_TYPE_BF16,        /* bf16 (bfloat16) */
    ...
    TOKEN_SIMD,             /* Simd (Simd(T, N) portable SIMD vector type) */
