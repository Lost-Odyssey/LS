...
//
// Scalar impls live here. Complex provides a call-compatible `static fn zero()` in
...
// std.tensor's bound-free generic arithmetic).

trait Zero { static fn zero() -> Self }

impl Zero for int { static fn zero() -> Self { return 0 } }
impl Zero for i64 { static fn zero() -> Self { return 0 as i64 } }
