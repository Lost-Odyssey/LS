# test_map_keys.cmake — map.keys()/values() driver.
#
# Runs a self-verifying map.keys()/values() sample three ways:
#   1. JIT run            — value correctness ("MK PASS", never "MK FAIL")
...
if(NOT LS_EXE OR NOT SAMPLE)
    message(FATAL_ERROR "test_map_keys.cmake requires LS_EXE and SAMPLE")
endif()
if(NOT TEST_NAME)
    set(TEST_NAME "map_keys")
endif()
...
if(NOT _jit_out MATCHES "MK PASS")
    message(FATAL_ERROR "${TEST_NAME} JIT missing 'MK PASS':\n${_jit_out}")
endif()
...
if(NOT _aot_out MATCHES "MK PASS")
    message(FATAL_ERROR "${TEST_NAME} AOT missing 'MK PASS':\n${_aot_out}")
endif()
