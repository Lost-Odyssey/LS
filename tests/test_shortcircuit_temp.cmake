# test_shortcircuit_temp.cmake — short-circuit temp-flush driver.
#
# Runs a self-verifying short-circuit sample three ways:
#   1. JIT run            — value correctness ("SC PASS", never "SC FAIL")
...
# @guards short-circuit && / || must flush owned temporaries
# @sources codegen_own.c:cg_flush_temps_scope_exit
cmake_minimum_required(VERSION 3.20)

if(NOT LS_EXE OR NOT SAMPLE)
    message(FATAL_ERROR "test_shortcircuit_temp.cmake requires LS_EXE and SAMPLE")
endif()
if(NOT TEST_NAME)
    set(TEST_NAME "shortcircuit_temp")
endif()
...
if(NOT _jit_out MATCHES "SC PASS")
    message(FATAL_ERROR "${TEST_NAME} JIT missing 'SC PASS':\n${_jit_out}")
endif()
...
if(NOT _aot_out MATCHES "SC PASS")
    message(FATAL_ERROR "${TEST_NAME} AOT missing 'SC PASS':\n${_aot_out}")
endif()
