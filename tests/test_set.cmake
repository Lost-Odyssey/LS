# test_set.cmake — std.core.set (generic container) correctness + memcheck driver.
#
...
#   1. JIT run            — value correctness ("SET PASS", no "FAIL")
...
# @guards std.core.set Set(T) over Map(T,bool)
# @sources lib/std/core/set.lls
...
if(NOT _jit_out MATCHES "SET PASS")
    message(FATAL_ERROR "${TEST_NAME} JIT missing 'SET PASS':\n${_jit_out}")
endif()
...
if(NOT _aot_out MATCHES "SET PASS")
    message(FATAL_ERROR "${TEST_NAME} AOT missing 'SET PASS':\n${_aot_out}")
endif()
