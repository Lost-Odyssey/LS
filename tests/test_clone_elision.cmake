# test_clone_elision.cmake — Clone-elision (A1 last-use analysis) guard driver.
#
# Runs the clone-elision sample three ways and asserts both correctness
# (output contains "CE PASS", never "FAIL") and memory safety (JIT --memcheck
# reports 0 leak / 0 double-free / 0 invalid free):
#   1. JIT run            — value correctness
#   2. AOT compile + run  — value correctness on the native path (a wrongly
#                           elided clone shows up as garbage / use-after-free)
#   3. JIT --memcheck     — no double-free of a moved-from source, no leak of
#                           a suppressed drop
#
# The sample was authored BEFORE the elision pass (pure-clone baseline); its
# output is the semantic contract the pass must preserve bit-for-bit.
#
...
if(NOT LS_EXE OR NOT SAMPLE)
    message(FATAL_ERROR "test_clone_elision.cmake requires LS_EXE and SAMPLE")
endif()
if(NOT TEST_NAME)
