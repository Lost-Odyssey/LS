...
static void test_enum_decl_layout(void) {
    ...
    char *ir = compile_to_ir(
        ...
        "def main() -> int { Color c = Red  return 0 }\n"
    );
    ASSERT_NOT_NULL(ir);
