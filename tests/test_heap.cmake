# test_set.cmake — BinaryHeap (trait-bound container) correctness + memcheck driver.
#
...
#   1. JIT run            — value correctness ("HEAP PASS", no "FAIL")
...
if(NOT _jit_out MATCHES "HEAP PASS")
    message(FATAL_ERROR "${TEST_NAME} JIT missing 'HEAP PASS':\n${_jit_out}")
endif()
...
if(NOT _aot_out MATCHES "HEAP PASS")
    message(FATAL_ERROR "${TEST_NAME} AOT missing 'HEAP PASS':\n${_aot_out}")
endif()
