# test_set.cmake — Deque (growable ring buffer) correctness + memcheck driver.
#
...
#   1. JIT run            — value correctness ("DEQUE PASS", no "FAIL")
...
# @guards std.core.deque Deque(T) growable ring
# @sources lib/std/core/deque.lls
cmake_minimum_required(VERSION 3.20)

if(NOT LS_EXE OR NOT SAMPLE)
    message(FATAL_ERROR "test_set.cmake requires LS_EXE and SAMPLE")
endif()
if(STDLIB)
...
if(NOT _jit_out MATCHES "DEQUE PASS")
    message(FATAL_ERROR "${TEST_NAME} JIT missing 'DEQUE PASS':\n${_jit_out}")
endif()
...
if(NOT _aot_out MATCHES "DEQUE PASS")
    message(FATAL_ERROR "${TEST_NAME} AOT missing 'DEQUE PASS':\n${_aot_out}")
endif()
