...
set(SAMPLE "${SAMPLE_DIR}/impl_trait_parse_test.lls")
...
execute_process(
    COMMAND "${LS_EXE}" run "${SAMPLE_DIR}/trait_missing_method.lls"
...
execute_process(
    COMMAND "${LS_EXE}" run "${SAMPLE_DIR}/trait_sig_mismatch.lls"
...
if(NOT "${ext_err}" MATCHES "not declared in interface")
    message(FATAL_ERROR
...
execute_process(
    COMMAND "${LS_EXE}" run "${SAMPLE_DIR}/trait_conflict_reject.lls"
