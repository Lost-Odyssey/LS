# test_plotfmt.cmake — generic self-verifying sample driver.
#
# Runs a self-verifying LS sample three ways:
#   1. JIT run            — value correctness ("<MARKER> PASS", never "FAIL")
...
if(NOT LS_EXE OR NOT SAMPLE)
    message(FATAL_ERROR "test_plotfmt.cmake requires LS_EXE and SAMPLE")
endif()
if(NOT TEST_NAME)
    set(TEST_NAME "plotfmt")
endif()
if(NOT MARKER)
    set(MARKER "PLOTFMT")
endif()
...
if(NOT _jit_out MATCHES "${MARKER} PASS")
    message(FATAL_ERROR "${TEST_NAME} JIT missing '${MARKER} PASS':\n${_jit_out}")
endif()
...
if(NOT _aot_out MATCHES "${MARKER} PASS")
    message(FATAL_ERROR "${TEST_NAME} AOT missing '${MARKER} PASS':\n${_aot_out}")
endif()
