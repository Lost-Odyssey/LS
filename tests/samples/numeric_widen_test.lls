...
//   - Return: def returning f64 can `return 5`
//   - Comparisons across mixed numeric types
import std.core.math as math

def double_it(f64 x) -> f64 { return x * 2.0 }
def sum_long(i64 a, i64 b) -> i64 { return a + b }
def sqrt_of(f64 x) -> f64 { return math.sqrt(x) }
