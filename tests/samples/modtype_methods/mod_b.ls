...
impl Widget {
    fn val(&self) -> int { return self.code + 100 }
    static fn make(int n) -> Widget { return Widget { code: n } }
}

enum Kind { Lo, Hi }
impl Kind {
    fn rank(&self) -> int { match self { Lo => { return 30 } Hi => { return 40 } } }
}
fn hi() -> Kind { return Hi }
