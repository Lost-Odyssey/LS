...
extern {
    ...
    def div(int numer, int denom) -> div_t
    def imaxdiv(i64 numer, i64 denom) -> imaxdiv_t
}

// --- (3) Byval-param compilation correctness ---
// We declare a def that takes a large struct by value. We never call it
...
extern def _ls_phase_e2_unused_byval(BigParam p) -> int
