// Phase 9 (math stdlib): built-in math module
// Verifies:
//   - import math resolves to compiler built-in (no math.ls present here)
//   - math.<fn>(...) lowers to LLVM intrinsic / libm direct call
