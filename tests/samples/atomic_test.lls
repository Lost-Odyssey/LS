// std.sync.atomic — single-threaded correctness of the lock-free scalar API.
...
def main() {
    ...
    // ---- acquire/release/relaxed ordering variants (single-thread = like get/set) ----
    Atomic(i64) o = {}
    o.store_release(42)
    if o.load_acquire() != 42 { @print("ATOMIC FAIL rel/acq") return }
    if o.load_relaxed() != 42 { @print("ATOMIC FAIL acq/rlx read") return }
    o.store_relaxed(99)
    if o.load_acquire() != 99 { @print("ATOMIC FAIL rlx store") return }
