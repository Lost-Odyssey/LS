...
fn main() {
    // ---- Test 1: load_file ----
    Result(JsonValue, Str) r1 = json.load_file("tests/samples/sample_data.json")
    match r1 {
    ...
    Result(JsonValue, Str) r2 = json.load_file("tests/samples/sample_data.json")
    match r2 {
    ...
    Result(JsonValue, Str) r3 = json.load_file("tests/samples/sample_data.json")
    match r3 {
    ...
    Result(JsonValue, Str) r4 = json.load_file("tests/samples/sample_data.json")
    match r4 {
        ...
        Ok(data) => {
            ...
            Result(JsonValue, Str) r4b = json.load_file("json_e2e_out.json")
            match r4b {
    ...
    Result(JsonValue, Str) r5 = json.load_file("tests/samples/sample_data.json")
    match r5 {
        ...
        Ok(data) => {
            ...
            Result(JsonValue, Str) r5c = json.load_file("json_e2e_out.json")
            match r5c {
    ...
    Result(JsonValue, Str) r6 = json.load_file("tests/samples/sample_data.json")
    match r6 {
        Err(e) => { print(f"FAIL 6: load error={e}"); return }
        Ok(data) => {
            Vec(Str) keys = json.object_keys(data)
    ...
    // ---- Clean up ----
    //Result(int, Str) rm = io.remove("json_e2e_out.json")
