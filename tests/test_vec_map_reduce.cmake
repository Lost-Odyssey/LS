...
if(NOT ar EQUAL 0 OR NOT ao MATCHES "RAWVEC MAP REDUCE PASS" OR ao MATCHES "FAIL ")
    message(FATAL_ERROR "vec_map_reduce AOT: bad output (rc=${ar}):\n${ae}\n${ao}")
endif()

message(STATUS "vec_map_reduce all passed")
