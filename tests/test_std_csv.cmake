# test_std_csv.cmake — std.text.csv driver.
#
# Runs the self-verifying csv sample three ways:
#   1. JIT run            — value correctness ("ALL DONE", never "FAIL")
...
if(NOT LS_EXE OR NOT SAMPLE)
    message(FATAL_ERROR "test_std_csv.cmake requires LS_EXE and SAMPLE")
endif()
if(NOT TEST_NAME)
...
if(NOT _jit_out MATCHES "ALL DONE")
    message(FATAL_ERROR "${TEST_NAME} JIT missing 'ALL DONE':\n${_jit_out}")
endif()
...
if(NOT _aot_out MATCHES "ALL DONE")
    message(FATAL_ERROR "${TEST_NAME} AOT missing 'ALL DONE':\n${_aot_out}")
endif()
