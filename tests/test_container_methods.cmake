# test_set.cmake — Vec/Map/Set method-completion batch correctness + memcheck driver.
#
...
#   1. JIT run            — value correctness ("CM PASS", no "FAIL")
...
if(NOT _jit_out MATCHES "CM PASS")
    message(FATAL_ERROR "${TEST_NAME} JIT missing 'CM PASS':\n${_jit_out}")
endif()
...
if(NOT _aot_out MATCHES "CM PASS")
    message(FATAL_ERROR "${TEST_NAME} AOT missing 'CM PASS':\n${_aot_out}")
endif()
