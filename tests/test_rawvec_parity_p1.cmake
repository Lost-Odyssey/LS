...
set(LS "${LS_EXE}")
set(SRC "${CMAKE_CURRENT_LIST_DIR}/samples/rawvec_parity_p1_test.ls")
set(OUT_EXE "${CMAKE_BINARY_DIR}/rawvec_parity_p1.exe")
if(STDLIB)
...
if(NOT ar EQUAL 0 OR NOT ao MATCHES "RAWVEC PARITY P1 PASS" OR ao MATCHES "FAIL ")
    message(FATAL_ERROR "rawvec_parity_p1 AOT: bad output (rc=${ar}):\n${ae}\n${ao}")
endif()

message(STATUS "rawvec_parity_p1 all passed")
