...
set(LS  "${LS_EXE}")
set(SRC "${CMAKE_CURRENT_LIST_DIR}/samples/rawvec_api_test.ls")
set(OUT_EXE "${CMAKE_BINARY_DIR}/rawvec_api.exe")
if(STDLIB)
...
if(NOT jo MATCHES "API PASS" OR jo MATCHES "FAIL ")
    message(FATAL_ERROR "rawvec_api JIT: bad output:\n${jo}")
endif()
...
message(STATUS "rawvec_api all passed")
